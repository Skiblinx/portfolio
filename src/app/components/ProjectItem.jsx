...
const ProjectItem = ({ title, bgImage, framework, projectUrl }) => {
  return (
    ...
    <div className='relative flex items-center justify-center h-auto w-full shadow-lg shadow-gray rounded-xl p-4 group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff]'>
      ...
      <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
        ...
        <Link href={projectUrl}>
          <p className='text-center py-3 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer'>Visit Site</p>
        </Link>
      </div>
    </div>
  )
