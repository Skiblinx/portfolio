    ...
    <div id='home' className='w-full h-screen text-center'>
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          ...
          <p className='py-4 text-gray-600 max-w-[70%] m-auto'>I&apos;m a front-end web developer specializing in building exceptional degital experiences. Currently, I&apos;m focused on building responsive front-end web applications while also improving my knowledge of emerging front-end technologies.</p>
